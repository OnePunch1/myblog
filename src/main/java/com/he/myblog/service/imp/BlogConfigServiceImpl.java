...
import com.he.myblog.dao.BlogConfigMapper;
...
public class BlogConfigServiceImpl implements BlogConfigService {
    ...
    public Map<String,String> getAllConfig() {
       List<BlogConfig> list=blogConfigMapper.getAllConfig();
       Map<String,String> configMap=list.stream().collect(Collectors.toMap(BlogConfig::getConfigName,BlogConfig::getConfigValue));
